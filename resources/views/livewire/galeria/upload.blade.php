                                    ...
                                    <div class="text-center">
                                        ...
                                        @if($images)
                                            <div class="flex flex-wrap gap-4 mt-4">
                                                @foreach($images as $image)
                                                    <div class="w-32 h-32 border rounded overflow-hidden shadow relative">
                                                        <button type="button" wire:click="removeImage({{ $loop->index }})"
                                                                class="absolute top-1 right-1 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center z-10">
                                                            &times;
                                                        </button>
                                        ...
                                        <div class="mt-4 flex justify-center text-sm leading-6 text-gray-600">
                                            <label for="image" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                                ...
                                                <input id="image" name="image" wire:model="images" type="file" class="sr-only" multiple>
