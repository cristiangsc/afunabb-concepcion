<div>
    <x-slot name="header">
        <div class="flex justify-between items-center gap-x-10">
            <x-principal.header title="AFUNABB" subtitle="Mantenedor de egresos"/>
            <x-fecha-hoy/>
        </div>
    </x-slot>
            ...
            <div class="columns-1 mx-4">
                <div class="relative mt-1 flex-1">
                    ...
                    <input type="text" id="table-search"
                           ...
                           placeholder="Buscar por tipo de egreso: " wire:model.live="search">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid xl:grid-cols-8 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-8">
        <div class="xl:col-start-3 xl:col-span-4 lg:col-start-2 lg:col-span-6 md:col-start-1 md:col-span-4">
            <x-table-dinamic caption="TIPOS DE EGRESOS">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-2 cursor-pointer sticky top-0">
                        @can('egresosTipos create')
                            <button
                                wire:click="OpenModalEgresoCreate()"
                                type="button"
    ...
    <x-modal-dinamic
        openCloseModal={{$OpenCloseModal}} title={{$title}}  actionTarget={{$actionTarget}} button={{$buttonEgreso}}>
        <x-component-input
            label=""
            placeholder=""
            name="name"
